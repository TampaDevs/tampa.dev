...
func (o *V20260125EventsGet200ResponseInner) UnmarshalJSON(data []byte) (err error) {
	...
	err = decoder.Decode(&var20260125EventsGet200ResponseInner)
...
func (v Nullable20260125EventsGet200ResponseInner) IsSet() bool {
	return v.isSet
}

func (v *Nullable20260125EventsGet200ResponseInner) Unset() {
	v.value = nil
	v.isSet = false
}
...
func (v Nullable20260125EventsGet200ResponseInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *Nullable20260125EventsGet200ResponseInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
