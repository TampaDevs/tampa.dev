...
type ApiServiceStatusGetRequest struct {
	ctx context.Context
...
/*
ServiceStatusGet Service status
...
Returns service status and configuration information, including platforms, groups, and aggregation diagnostics.
 ...
 @return ApiServiceStatusGetRequest
*/
func (a *ServiceAPIService) ServiceStatusGet(ctx context.Context) ApiServiceStatusGetRequest {
	return ApiServiceStatusGetRequest{
		ApiService: a,
		ctx: ctx,
	}
