  ...
  class VUserBadge < ApiModelBase
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `TampaEventsAPI::VUserBadge` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `TampaEventsAPI::VUserBadge`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'awarded_at')
        self.awarded_at = attributes[:'awarded_at']
      else
        self.awarded_at = nil
      end
    ...
    def list_invalid_properties
      ...
      if @awarded_at.nil?
        invalid_properties.push('invalid value for "awarded_at", awarded_at cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @awarded_at.nil?
    ...
    # Custom attribute writer method with validation
    # @param [Object] awarded_at Value to be assigned
    def awarded_at=(awarded_at)
      if awarded_at.nil?
        fail ArgumentError, 'awarded_at cannot be nil'
      end
    ...
    def hash
      [name, slug, description, icon, icon_url, color, points, awarded_at, group, rarity].hash
    end
