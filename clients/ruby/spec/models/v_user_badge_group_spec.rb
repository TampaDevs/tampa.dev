...
# Unit tests for TampaEventsAPI::VUserBadgeGroup
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe TampaEventsAPI::VUserBadgeGroup do
  #let(:instance) { TampaEventsAPI::VUserBadgeGroup.new }

  describe 'test an instance of VUserBadgeGroup' do
    it 'should create an instance of VUserBadgeGroup' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(TampaEventsAPI::VUserBadgeGroup)
    end
  end
