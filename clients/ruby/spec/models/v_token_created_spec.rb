...
# Unit tests for TampaEventsAPI::VTokenCreated
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe TampaEventsAPI::VTokenCreated do
  #let(:instance) { TampaEventsAPI::VTokenCreated.new }

  describe 'test an instance of VTokenCreated' do
    it 'should create an instance of VTokenCreated' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(TampaEventsAPI::VTokenCreated)
    end
  end
