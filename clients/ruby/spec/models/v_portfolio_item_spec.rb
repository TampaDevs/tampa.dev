...
# Unit tests for TampaEventsAPI::VPortfolioItem
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe TampaEventsAPI::VPortfolioItem do
  #let(:instance) { TampaEventsAPI::VPortfolioItem.new }

  describe 'test an instance of VPortfolioItem' do
    it 'should create an instance of VPortfolioItem' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(TampaEventsAPI::VPortfolioItem)
    end
  end
