...
# Unit tests for TampaEventsAPI::VErrorResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe TampaEventsAPI::VErrorResponse do
  #let(:instance) { TampaEventsAPI::VErrorResponse.new }

  describe 'test an instance of VErrorResponse' do
    it 'should create an instance of VErrorResponse' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(TampaEventsAPI::VErrorResponse)
    end
  end
