...
# Unit tests for TampaEventsAPI::VRsvpSummary
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe TampaEventsAPI::VRsvpSummary do
  #let(:instance) { TampaEventsAPI::VRsvpSummary.new }

  describe 'test an instance of VRsvpSummary' do
    it 'should create an instance of VRsvpSummary' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(TampaEventsAPI::VRsvpSummary)
    end
  end
  ...
  describe 'test attribute "waitlisted"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
