...
# Unit tests for TampaEventsAPI::VScope
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe TampaEventsAPI::VScope do
  #let(:instance) { TampaEventsAPI::VScope.new }

  describe 'test an instance of VScope' do
    it 'should create an instance of VScope' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(TampaEventsAPI::VScope)
    end
  end
  ...
  describe 'test attribute "implies"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
