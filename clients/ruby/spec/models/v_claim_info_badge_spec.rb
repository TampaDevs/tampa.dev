...
# Unit tests for TampaEventsAPI::VClaimInfoBadge
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe TampaEventsAPI::VClaimInfoBadge do
  #let(:instance) { TampaEventsAPI::VClaimInfoBadge.new }

  describe 'test an instance of VClaimInfoBadge' do
    it 'should create an instance of VClaimInfoBadge' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(TampaEventsAPI::VClaimInfoBadge)
    end
  end
