...
# Unit tests for TampaEventsAPI::VFollowEntry
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe TampaEventsAPI::VFollowEntry do
  #let(:instance) { TampaEventsAPI::VFollowEntry.new }

  describe 'test an instance of VFollowEntry' do
    it 'should create an instance of VFollowEntry' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(TampaEventsAPI::VFollowEntry)
    end
  end
  ...
  describe 'test attribute "followed_at"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
