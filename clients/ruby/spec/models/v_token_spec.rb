...
# Unit tests for TampaEventsAPI::VToken
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe TampaEventsAPI::VToken do
  #let(:instance) { TampaEventsAPI::VToken.new }

  describe 'test an instance of VToken' do
    it 'should create an instance of VToken' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(TampaEventsAPI::VToken)
    end
  end
