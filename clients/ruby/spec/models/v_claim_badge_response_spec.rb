...
# Unit tests for TampaEventsAPI::VClaimBadgeResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe TampaEventsAPI::VClaimBadgeResponse do
  #let(:instance) { TampaEventsAPI::VClaimBadgeResponse.new }

  describe 'test an instance of VClaimBadgeResponse' do
    it 'should create an instance of VClaimBadgeResponse' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(TampaEventsAPI::VClaimBadgeResponse)
    end
  end
