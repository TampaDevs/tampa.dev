...
# Unit tests for TampaEventsAPI::VCreateTokenRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe TampaEventsAPI::VCreateTokenRequest do
  #let(:instance) { TampaEventsAPI::VCreateTokenRequest.new }

  describe 'test an instance of VCreateTokenRequest' do
    it 'should create an instance of VCreateTokenRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(TampaEventsAPI::VCreateTokenRequest)
    end
  end
