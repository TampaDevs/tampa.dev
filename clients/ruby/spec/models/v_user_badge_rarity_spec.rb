...
# Unit tests for TampaEventsAPI::VUserBadgeRarity
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe TampaEventsAPI::VUserBadgeRarity do
  #let(:instance) { TampaEventsAPI::VUserBadgeRarity.new }

  describe 'test an instance of VUserBadgeRarity' do
    it 'should create an instance of VUserBadgeRarity' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(TampaEventsAPI::VUserBadgeRarity)
    end
  end
  ...
  describe 'test attribute "tier"' do
    it 'should work' do
      ...
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["common", "uncommon", "rare", "epic", "legendary"])
