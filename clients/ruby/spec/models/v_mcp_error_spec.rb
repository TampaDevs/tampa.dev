...
# Unit tests for TampaEventsAPI::VMcpError
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe TampaEventsAPI::VMcpError do
  #let(:instance) { TampaEventsAPI::VMcpError.new }

  describe 'test an instance of VMcpError' do
    it 'should create an instance of VMcpError' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(TampaEventsAPI::VMcpError)
    end
  end
