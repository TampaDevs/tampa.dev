...
# Unit tests for TampaEventsAPI::VPortfolioItemRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe TampaEventsAPI::VPortfolioItemRequest do
  #let(:instance) { TampaEventsAPI::VPortfolioItemRequest.new }

  describe 'test an instance of VPortfolioItemRequest' do
    it 'should create an instance of VPortfolioItemRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(TampaEventsAPI::VPortfolioItemRequest)
    end
  end
