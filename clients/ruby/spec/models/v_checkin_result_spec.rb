...
# Unit tests for TampaEventsAPI::VCheckinResult
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe TampaEventsAPI::VCheckinResult do
  #let(:instance) { TampaEventsAPI::VCheckinResult.new }

  describe 'test an instance of VCheckinResult' do
    it 'should create an instance of VCheckinResult' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(TampaEventsAPI::VCheckinResult)
    end
  end
  ...
  describe 'test attribute "checked_in_at"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
