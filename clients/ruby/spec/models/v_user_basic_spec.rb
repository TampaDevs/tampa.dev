...
# Unit tests for TampaEventsAPI::VUserBasic
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe TampaEventsAPI::VUserBasic do
  #let(:instance) { TampaEventsAPI::VUserBasic.new }

  describe 'test an instance of VUserBasic' do
    it 'should create an instance of VUserBasic' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(TampaEventsAPI::VUserBasic)
    end
  end
