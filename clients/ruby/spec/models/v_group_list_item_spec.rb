...
# Unit tests for TampaEventsAPI::VGroupListItem
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe TampaEventsAPI::VGroupListItem do
  #let(:instance) { TampaEventsAPI::VGroupListItem.new }

  describe 'test an instance of VGroupListItem' do
    it 'should create an instance of VGroupListItem' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(TampaEventsAPI::VGroupListItem)
    end
  end
