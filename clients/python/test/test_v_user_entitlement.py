...
class TestVUserEntitlement(unittest.TestCase):
    """VUserEntitlement unit test stubs"""
    ...
    def make_instance(self, include_optional) -> VUserEntitlement:
        """Test VUserEntitlement
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `VUserEntitlement`
        """
        model = VUserEntitlement()
        if include_optional:
            return VUserEntitlement(
                id = '',
                entitlement = '',
                granted_at = '',
                expires_at = '',
