...
class TestVUserBadgeGroup(unittest.TestCase):
    """VUserBadgeGroup unit test stubs"""
    ...
    def make_instance(self, include_optional) -> VUserBadgeGroup:
        """Test VUserBadgeGroup
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `VUserBadgeGroup`
        """
        model = VUserBadgeGroup()
        if include_optional:
            return VUserBadgeGroup(
                id = '',
                name = '',
                urlname = '',
                photo_url = ''
