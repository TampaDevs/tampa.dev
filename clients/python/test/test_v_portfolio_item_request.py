...
class TestVPortfolioItemRequest(unittest.TestCase):
    """VPortfolioItemRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> VPortfolioItemRequest:
        """Test VPortfolioItemRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `VPortfolioItemRequest`
        """
        model = VPortfolioItemRequest()
        if include_optional:
            return VPortfolioItemRequest(
                title = '0',
                description = '',
                url = '',
                image_url = '',
    ...
    def testVPortfolioItemRequest(self):
        """Test VPortfolioItemRequest"""
