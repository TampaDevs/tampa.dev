...
class TestVMcpError(unittest.TestCase):
    """VMcpError unit test stubs"""
    ...
    def make_instance(self, include_optional) -> VMcpError:
        """Test VMcpError
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `VMcpError`
        """
        model = VMcpError()
        if include_optional:
            return VMcpError(
