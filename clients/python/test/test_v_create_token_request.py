...
class TestVCreateTokenRequest(unittest.TestCase):
    """VCreateTokenRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> VCreateTokenRequest:
        """Test VCreateTokenRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `VCreateTokenRequest`
        """
        model = VCreateTokenRequest()
        if include_optional:
            return VCreateTokenRequest(
                name = '0',
                scopes = [
                    ''
                    ],
    ...
    def testVCreateTokenRequest(self):
        """Test VCreateTokenRequest"""
