...
class TestVLinkedAccount(unittest.TestCase):
    """VLinkedAccount unit test stubs"""
    ...
    def make_instance(self, include_optional) -> VLinkedAccount:
        """Test VLinkedAccount
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `VLinkedAccount`
        """
        model = VLinkedAccount()
        if include_optional:
            return VLinkedAccount(
                provider = '',
                provider_username = '',
                provider_email = '',
                created_at = ''
