...
class TestVV1ScopesGet200Response(unittest.TestCase):
    """VV1ScopesGet200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> VV1ScopesGet200Response:
        """Test VV1ScopesGet200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `VV1ScopesGet200Response`
        """
        model = VV1ScopesGet200Response()
        if include_optional:
            return VV1ScopesGet200Response(
                data = [
                    tampa_events_api.models.scope.Scope(
                        name = '', 
                        description = '', 
                        implies = [
                            ''
    ...
    def testVV1ScopesGet200Response(self):
        """Test VV1ScopesGet200Response"""
