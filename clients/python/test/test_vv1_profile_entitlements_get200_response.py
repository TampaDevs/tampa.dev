...
class TestVV1ProfileEntitlementsGet200Response(unittest.TestCase):
    """VV1ProfileEntitlementsGet200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> VV1ProfileEntitlementsGet200Response:
        """Test VV1ProfileEntitlementsGet200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `VV1ProfileEntitlementsGet200Response`
        """
        model = VV1ProfileEntitlementsGet200Response()
        if include_optional:
            return VV1ProfileEntitlementsGet200Response(
                data = [
                    tampa_events_api.models.user_entitlement.UserEntitlement(
                        id = '', 
                        entitlement = '', 
                        granted_at = '', 
                        expires_at = '', 
    ...
    def testVV1ProfileEntitlementsGet200Response(self):
        """Test VV1ProfileEntitlementsGet200Response"""
