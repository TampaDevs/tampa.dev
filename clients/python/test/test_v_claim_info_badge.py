...
class TestVClaimInfoBadge(unittest.TestCase):
    """VClaimInfoBadge unit test stubs"""
    ...
    def make_instance(self, include_optional) -> VClaimInfoBadge:
        """Test VClaimInfoBadge
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `VClaimInfoBadge`
        """
        model = VClaimInfoBadge()
        if include_optional:
            return VClaimInfoBadge(
                name = '',
                slug = '',
                description = '',
                icon = '',
