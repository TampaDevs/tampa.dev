...
class TestVEventListItem(unittest.TestCase):
    """VEventListItem unit test stubs"""
    ...
    def make_instance(self, include_optional) -> VEventListItem:
        """Test VEventListItem
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `VEventListItem`
        """
        model = VEventListItem()
        if include_optional:
            return VEventListItem(
                id = '',
                title = '',
                description = '',
                start_time = '',
