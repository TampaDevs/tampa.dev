...
class TestVErrorResponse(unittest.TestCase):
    """VErrorResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> VErrorResponse:
        """Test VErrorResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `VErrorResponse`
        """
        model = VErrorResponse()
        if include_optional:
