...
class TestVClaimInfo(unittest.TestCase):
    """VClaimInfo unit test stubs"""
    ...
    def make_instance(self, include_optional) -> VClaimInfo:
        """Test VClaimInfo
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `VClaimInfo`
        """
        model = VClaimInfo()
        if include_optional:
            return VClaimInfo(
