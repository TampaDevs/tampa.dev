...
class TestVPagination(unittest.TestCase):
    """VPagination unit test stubs"""
    ...
    def make_instance(self, include_optional) -> VPagination:
        """Test VPagination
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `VPagination`
        """
        model = VPagination()
        if include_optional:
            return VPagination(
