...
class TestVEventListItemGroup(unittest.TestCase):
    """VEventListItemGroup unit test stubs"""
    ...
    def make_instance(self, include_optional) -> VEventListItemGroup:
        """Test VEventListItemGroup
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `VEventListItemGroup`
        """
        model = VEventListItemGroup()
        if include_optional:
            return VEventListItemGroup(
                id = '',
                name = '',
                urlname = ''
            )
    ...
    def testVEventListItemGroup(self):
        """Test VEventListItemGroup"""
