...
class VV1ProfileAchievementsGet200Response(BaseModel):
    """
    VV1ProfileAchievementsGet200Response
    """ # noqa: E501
    data: List[VAchievementProgress]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": [VAchievementProgress.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None
        })
        return _obj
