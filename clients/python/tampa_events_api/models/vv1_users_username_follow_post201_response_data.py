...
class VV1UsersUsernameFollowPost201ResponseData(BaseModel):
    """
    ...
    def following_validate_enum(cls, value):
        """Validates the enum"""
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of VV1UsersUsernameFollowPost201ResponseData from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of VV1UsersUsernameFollowPost201ResponseData from a dict"""
        if obj is None:
            return None
