...
class VPortfolioItemUpdateRequest(BaseModel):
    """
    ...
    sort_order: Optional[Annotated[int, Field(strict=True, ge=0)]] = Field(default=0, alias="sortOrder")
    __properties: ClassVar[List[str]] = ["title", "description", "url", "imageUrl", "sortOrder"]
