...
class VV1ProfileBadgesGet200Response(BaseModel):
    """
    VV1ProfileBadgesGet200Response
    """ # noqa: E501
    data: List[VUserBadge]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": [VUserBadge.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None
        })
        return _obj
