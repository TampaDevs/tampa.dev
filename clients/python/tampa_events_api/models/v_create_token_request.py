...
class VCreateTokenRequest(BaseModel):
    """
    VCreateTokenRequest
    """ # noqa: E501
    name: Annotated[str, Field(min_length=1, strict=True, max_length=100)] = Field(description="Human-readable name for the token")
    scopes: Annotated[List[StrictStr], Field(min_length=1)] = Field(description="OAuth scopes to grant to this token")
    expires_in_days: Optional[Annotated[int, Field(le=365, strict=True, ge=1)]] = Field(default=None, description="Token expiry in days (1-365, default: no expiry)", alias="expiresInDays")
