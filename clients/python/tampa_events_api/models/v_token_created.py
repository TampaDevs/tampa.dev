...
class VTokenCreated(BaseModel):
    """
    VTokenCreated
    """ # noqa: E501
    id: StrictStr
    name: StrictStr
    token: StrictStr = Field(description="Full token value. Store securely — it cannot be retrieved again.")
    token_prefix: StrictStr = Field(alias="tokenPrefix")
    scopes: StrictStr
    expires_at: StrictStr = Field(alias="expiresAt")
    created_at: StrictStr = Field(alias="createdAt")
    __properties: ClassVar[List[str]] = ["id", "name", "token", "tokenPrefix", "scopes", "expiresAt", "createdAt"]
