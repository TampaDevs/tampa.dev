...
class VV1GroupsGet200Response(BaseModel):
    """
    VV1GroupsGet200Response
    """ # noqa: E501
    data: List[VGroupListItem]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": [VGroupListItem.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None,
            "pagination": VPagination.from_dict(obj["pagination"]) if obj.get("pagination") is not None else None
        })
        return _obj
