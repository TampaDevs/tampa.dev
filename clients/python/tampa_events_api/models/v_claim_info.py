...
class VClaimInfo(BaseModel):
    """
    VClaimInfo
    """ # noqa: E501
    badge: VClaimInfoBadge
    group: VClaimInfoGroup
    claimable: StrictBool
    reason: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["badge", "group", "claimable", "reason"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "badge": VClaimInfoBadge.from_dict(obj["badge"]) if obj.get("badge") is not None else None,
            "group": VClaimInfoGroup.from_dict(obj["group"]) if obj.get("group") is not None else None,
