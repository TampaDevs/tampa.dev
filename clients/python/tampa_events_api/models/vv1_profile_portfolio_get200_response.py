...
class VV1ProfilePortfolioGet200Response(BaseModel):
    """
    VV1ProfilePortfolioGet200Response
    """ # noqa: E501
    data: List[VPortfolioItem]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": [VPortfolioItem.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None
        })
        return _obj
