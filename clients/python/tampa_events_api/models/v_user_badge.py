...
class VUserBadge(BaseModel):
    ...
    awarded_at: StrictStr = Field(alias="awardedAt")
    group: VUserBadgeGroup
    rarity: VUserBadgeRarity
    __properties: ClassVar[List[str]] = ["name", "slug", "description", "icon", "iconUrl", "color", "points", "awardedAt", "group", "rarity"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "group": VUserBadgeGroup.from_dict(obj["group"]) if obj.get("group") is not None else None,
            "rarity": VUserBadgeRarity.from_dict(obj["rarity"]) if obj.get("rarity") is not None else None
        })
        return _obj
