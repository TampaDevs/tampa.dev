...
class VAchievementProgress(BaseModel):
    """
    ...
    completed_at: StrictStr = Field(alias="completedAt")
    badge_slug: StrictStr = Field(alias="badgeSlug")
    hidden: StrictBool
    __properties: ClassVar[List[str]] = ["key", "name", "description", "icon", "color", "targetValue", "currentValue", "completedAt", "badgeSlug", "hidden"]
