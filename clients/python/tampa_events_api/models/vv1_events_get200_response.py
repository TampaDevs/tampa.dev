...
class VV1EventsGet200Response(BaseModel):
    """
    VV1EventsGet200Response
    """ # noqa: E501
    data: List[VEventListItem]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": [VEventListItem.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None,
