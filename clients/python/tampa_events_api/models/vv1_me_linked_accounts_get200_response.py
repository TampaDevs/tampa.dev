...
class VV1MeLinkedAccountsGet200Response(BaseModel):
    """
    VV1MeLinkedAccountsGet200Response
    """ # noqa: E501
    data: List[VLinkedAccount]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": [VLinkedAccount.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None
        })
        return _obj
