...
class VLinkedAccount(BaseModel):
    """
    VLinkedAccount
    """ # noqa: E501
    provider: StrictStr
    provider_username: StrictStr = Field(alias="providerUsername")
    provider_email: StrictStr = Field(alias="providerEmail")
    created_at: StrictStr = Field(alias="createdAt")
    __properties: ClassVar[List[str]] = ["provider", "providerUsername", "providerEmail", "createdAt"]
