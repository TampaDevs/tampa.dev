...
class Model20260125SchemasGet200Response(BaseModel):
    """
    Model20260125SchemasGet200Response
    """ # noqa: E501
    schemas: List[Model20260125SchemasGet200ResponseSchemasInner]
    version: StrictStr
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "schemas": [Model20260125SchemasGet200ResponseSchemasInner.from_dict(_item) for _item in obj["schemas"]] if obj.get("schemas") is not None else None,
