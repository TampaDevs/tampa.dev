...
class VClaimBadgeResponse(BaseModel):
    """
    VClaimBadgeResponse
    """ # noqa: E501
    badge: VClaimBadgeResponseBadge
    __properties: ClassVar[List[str]] = ["badge"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "badge": VClaimBadgeResponseBadge.from_dict(obj["badge"]) if obj.get("badge") is not None else None
        })
        return _obj
