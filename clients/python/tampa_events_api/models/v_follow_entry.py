...
class VFollowEntry(BaseModel):
    ...
    followed_at: StrictStr = Field(alias="followedAt")
    __properties: ClassVar[List[str]] = ["username", "name", "avatarUrl", "followedAt"]
