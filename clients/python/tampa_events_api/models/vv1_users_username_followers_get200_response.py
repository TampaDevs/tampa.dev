...
class VV1UsersUsernameFollowersGet200Response(BaseModel):
    """
    VV1UsersUsernameFollowersGet200Response
    """ # noqa: E501
    data: List[VFollowEntry]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": [VFollowEntry.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None,
