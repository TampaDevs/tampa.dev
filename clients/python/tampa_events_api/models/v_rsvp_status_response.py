...
class VRsvpStatusResponse(BaseModel):
    """
    VRsvpStatusResponse
    """ # noqa: E501
    rsvp: VRsvp
    __properties: ClassVar[List[str]] = ["rsvp"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of rsvp
        if self.rsvp:
            _dict['rsvp'] = self.rsvp.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "rsvp": VRsvp.from_dict(obj["rsvp"]) if obj.get("rsvp") is not None else None
        })
        return _obj
