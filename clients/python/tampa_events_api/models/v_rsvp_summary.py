...
class VRsvpSummary(BaseModel):
    """
    VRsvpSummary
    """ # noqa: E501
    total: Union[StrictFloat, StrictInt]
    confirmed: Union[StrictFloat, StrictInt]
    waitlisted: Union[StrictFloat, StrictInt]
    cancelled: Union[StrictFloat, StrictInt]
    capacity: Union[StrictFloat, StrictInt]
    __properties: ClassVar[List[str]] = ["total", "confirmed", "waitlisted", "cancelled", "capacity"]
