...
class ClaimsApi:
    ...
    def v1_claim_code_get(
        ...
        _param = self._v1_claim_code_get_serialize(
            code=code,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "VV1ClaimCodeGet200Response",
            '404': "VErrorResponse",
            '410': "VErrorResponse",
        }
    ...
    @validate_call
    def v1_claim_code_get_with_http_info(
        self,
        code: StrictStr,
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[VV1ClaimCodeGet200Response]:
        """Get badge claim info
    ...
    @validate_call
    def v1_claim_code_get_without_preload_content(
        self,
        code: StrictStr,
        _request_timeout: Union[
            None,
    ...
    def _v1_claim_code_get_serialize(
        self,
        code,
        _request_auth,
        _content_type,
    ...
    def v1_claim_code_post(
        ...
        _param = self._v1_claim_code_post_serialize(
            code=code,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '201': "VV1ClaimCodePost201Response",
            '401': "VErrorResponse",
            '403': "VErrorResponse",
            '404': "VErrorResponse",
            '409': "VErrorResponse",
    ...
    @validate_call
    def v1_claim_code_post_with_http_info(
        self,
        code: StrictStr,
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[VV1ClaimCodePost201Response]:
        """Claim a badge
    ...
    @validate_call
    def v1_claim_code_post_without_preload_content(
        self,
        code: StrictStr,
        _request_timeout: Union[
            None,
    ...
    def _v1_claim_code_post_serialize(
        self,
        code,
        _request_auth,
        _content_type,
