...
class ServiceApi:
    ...
    def service_status_get(
        ...
        _param = self._service_status_get_serialize(
    ...
    @validate_call
    def service_status_get_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    @validate_call
    def service_status_get_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def _service_status_get_serialize(
        self,
        _request_auth,
        _content_type,
        _headers,
