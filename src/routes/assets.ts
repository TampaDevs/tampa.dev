...
function createAssetsRoutes() {
  ...
  <text x="130" y="20" font-family="${font}" font-size="13" font-weight="600" text-anchor="middle" dy="0.35em"><tspan fill="${text}">Sign in with Tampa</tspan><tspan fill="${coral}">.dev</tspan></text>
</svg>`;
