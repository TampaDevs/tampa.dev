---
title: "Terms of Service | Tampa.dev"
description: "Tampa.dev Code of Conduct outlining our expectations for community participants and steps for reporting unacceptable behavior."
h1: "Terms of Service"
---

# Code of Conduct

This code of conduct outlines our expectations for participants within the Tampa.dev community (relevant to both our Slack and Meetup), as well as steps to reporting unacceptable behavior. We are committed to providing a welcoming and inspiring community for all and expect our code of conduct to be honored. Anyone who violates this code of conduct may be banned from the community.
...
- Via Slack: Use the command `/admin your message` anywhere on Slack to privately report incidents, and a moderator will get in touch with you promptly
