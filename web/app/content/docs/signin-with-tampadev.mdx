...
Want to see it in action? Check out the [live demo app](https://tampadev-signin-demo.pages.dev/) to try the OAuth flow yourself. The [source code](https://github.com/TampaDevs/tampadev-signin-demo) is available on GitHub as a reference implementation.
...
<div style={{ display: 'flex', gap: '16px', alignItems: 'center', margin: '24px 0', flexWrap: 'wrap' }}>
  <div style={{ padding: '16px 24px', borderRadius: '8px', background: '#f8f9fa' }}>
    <img src="https://api.tampa.dev/assets/signin-button.svg" alt="Sign in with Tampa.dev" height="40" />
  </div>
  <div style={{ padding: '16px 24px', borderRadius: '8px', background: '#1a1a1a' }}>
    <img src="https://api.tampa.dev/assets/signin-button.svg?theme=dark" alt="Sign in with Tampa.dev (dark)" height="40" />
  </div>
</div>
